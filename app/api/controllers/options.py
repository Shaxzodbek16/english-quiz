...
class OptionsController:
    ...
    async def get_all_options(self) -> Sequence[OptionsResponseSchema]:
        return await self.__options_repository.get_all_options()
    ...
    async def create_option(
        ...
        return await self.__options_repository.create_option(option)
    ...
    async def update_option(
        ...
        if res is None:
            raise HTTPException(status_code=404, detail="Option not found")
        return await self.__options_repository.update_option(option_id, option)
